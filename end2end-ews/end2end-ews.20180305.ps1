# end2end-ews
#
# Dieses Script versucht den Posteingang und Kalender eines Postfach # über EWS Impersonation zu öffnen # # Voraussettungen # - Exchange 2007 SP1+ # - NET 3.5 # - "Microsoft.Exchange.WebServices.dll
...
while ($true){
    ...
    if ($statistics.beserver -ne $result.service.HttpResponseHeaders["X-BEServer"]){
        ...
        write-host "New X-BEServer $($beserver) detected"
    }
