...
Mailboxpath(0) = "CN=Steffen Weitze,OU=AB-IT-Systeme,DC=ADS,DC=AIRBERLIN,DC=COM"&vbtab&"\\Top of Information Store\Kalender"
Mailboxpath(1) = "CN=Grupos,OU=AB-PMI,DC=ADS,DC=AIRBERLIN,DC=COM"&vbtab&"\\Top of Information Store\Kalender"
...
do
	...
	for intcount = lbound (Mailboxpath) to ubound (Mailboxpath)
		...
		call xmlWriter.WriteElementString("dauer", (now-dtdauer)*86400000)
...
sub writexslt(strfilename)
	...
	txtxsl = _
		...
		"	<th>User:</th> " & vbcrlf & _
		"	<th>Timestamp:</th> " & vbcrlf & _
		"	<th>Dauer:</th> " & vbcrlf & _
		"  </tr>" & vbcrlf & _
		"<xsl:for-each select=""MailboxPerfmon/object""> " & vbcrlf & _
		"	<tr>" & vbcrlf & _
		"	<td>" & vbcrlf & _
		"		<xsl:value-of select=""user"" /> " & vbcrlf & _
		"	</td>" & vbcrlf & _
		"	<td>" & vbcrlf & _
		"		<xsl:value-of select=""timestamp2"" /> " & vbcrlf & _
		"	</td>" & vbcrlf & _
		"	<td>" & vbcrlf & _
		"		<xsl:value-of select=""dauer"" /> " & vbcrlf & _
		"	</td>" & vbcrlf & _
		"	</tr>" & vbcrlf & _
